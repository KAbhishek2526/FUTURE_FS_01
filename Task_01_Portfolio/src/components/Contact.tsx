...
export default function Contact() {
  const email = "kokkiligaddaabhishek2006@gmail.com";
    ...
    <section id="contact" className="relative z-20 bg-[#121212] py-40 px-6 md:px-12 lg:px-24 border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <a 
            href={`mailto:${email}`}
            className="glass flex items-center gap-3 px-8 py-4 rounded-full hover:bg-white/10 hover:border-white/20 hover:scale-105 active:scale-95 transition-all duration-300 relative overflow-hidden group glow-blue w-full sm:w-auto shadow-[0_0_15px_rgba(37,99,235,0.2)] hover:shadow-[0_0_25px_rgba(37,99,235,0.4)] hover:border-blue-500/30"
          >
            <Mail className="text-blue-400 group-hover:text-blue-300 transition-colors" size={20} />
            <span className="text-white/90 font-medium tracking-wide group-hover:underline group-hover:text-blue-200 decoration-blue-400/50 underline-offset-4 transition-all">Email Me</span>
          </a>
